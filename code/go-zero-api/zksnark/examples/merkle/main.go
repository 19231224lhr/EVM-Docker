...
func main() {
	...
	if err != nil {
		fmt.Printf("Failed to marshal proving key: %v\n", err)
		return
	}

	err = ioutil.WriteFile("proving_key.json", pkBytes, 0644)
	if err != nil {
		fmt.Printf("Failed to write proving key to file: %v\n", err)
		return
	}
	...
	//	return
	//}
	//// fmt.Printf("json : ", string(a))
	//var b groth16.ProvingKey
	//err = json.Unmarshal(a, &b)
	//if err != nil {
	//	fmt.Printf("Error in json.Unmarshal : ", err)
	//	return
	//}
	//fmt.Printf("If equal? ", pk == b)
	//if err != nil {
